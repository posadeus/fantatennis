...
class JdbcTournamentDaoTest {
  ...
  inner class PersistNewTournaments {
    ...
    fun `not all tournaments are persisted`() {
      ...
      val tournament1 = aNewJdbcTournamentDto(atpTourId = AN_ATP_TOUR_ID,
                                              tennisTvId = A_TENNIS_TV_ID,
                                              name = A_NAME,
                                              startDate = A_START_DATE,
                                              endDate = AN_END_DATE,
                                              ...
                                              surface = A_SURFACE,
                                              location = A_LOCATION)
      val tournament2 = aNewJdbcTournamentDto(atpTourId = 224,
                                              tennisTvId = ANOTHER_TENNIS_TV_ID,
                                              name = ANOTHER_NAME,
                                              startDate = ANOTHER_START_DATE,
                                              endDate = ANOTHER_END_DATE,
    ...
    fun `multiple tournaments are not persisted`() {
      ...
      val tournament1 = aNewJdbcTournamentDto(atpTourId = AN_ATP_TOUR_ID,
                                              ...
                                              surface = A_SURFACE,
                                              location = A_LOCATION)
      val tournament2 = aNewJdbcTournamentDto(atpTourId = ANOTHER_ATP_TOUR_ID,
                                              tennisTvId = ANOTHER_TENNIS_TV_ID,
                                              name = ANOTHER_NAME,
                                              startDate = ANOTHER_START_DATE,
                                              endDate = ANOTHER_END_DATE,
