...
class JdbcRetrieveFantaTournamentResultsRepositoryIT {
  ...
  fun `tournament results successfully retrieved`() {
    ...
    val mn98 = TeamPlayerDto(fullName = "MMM NNN", fantaPoints = 0.00)
    val k5l8 = TeamPlayerDto(fullName = "KKK LLL", fantaPoints = 34.00)
    val s7t5 = TeamPlayerDto(fullName = "SSS TTT", fantaPoints = 12.00)
    ...
    val team1 = TeamDto(owner = "AN_OWNER", players = listOf(k5l8, a0b1, s7t5, mn98), totalScore = 58.00)
