...
class WimbledonTeamBuilder(private var firstNameA: Any? = null,
  ...
  fun withIdA(idA: String): WimbledonTeamBuilder {
    this.idA = idA
    return this
  }

  fun withWon(won: Boolean?): WimbledonTeamBuilder {
    this.won = won
    return this
  }

  fun build() = WimbledonTeam(firstNameA,
                              lastNameA,
                              displayNameA,
                              idA,
                              nationA,
