...
sealed interface WimbledonResponse

data object WimbledonErrorResponse : WimbledonResponse
data class WimbledonOkResponse(val eventName: Any?,
                               val drawSize: Any?,
                               val drawFormat: Any?,
                               val totalRounds: Any?,
                               val prizeMoney: Any?,
                               val matches: Array<WimbledonMatch>) : WimbledonResponse {

  override fun equals(other: Any?): Boolean {
    if (this === other) return true
    if (javaClass != other?.javaClass) return false

    other as WimbledonOkResponse
...
data class WimbledonMatch(val match_id: Any?,
                          val eventName: Any?,
                          ...
                          val winner: String?,
                          val epoch: Any?,
                          val team1: WimbledonTeam,
                          val team2: WimbledonTeam,
                          val flags: Any?,
                          val scores: Any?)

data class WimbledonTeam(val firstNameA: Any?,
                         val lastNameA: Any?,
