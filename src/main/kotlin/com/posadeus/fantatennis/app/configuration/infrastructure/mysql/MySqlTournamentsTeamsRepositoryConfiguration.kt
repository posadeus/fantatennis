...
@Configuration
class MySqlTournamentsTeamsRepositoryConfiguration {

  @Bean
  fun mySqlFantaTournamentsTeamsRepository(fantaTournamentsTeamsDao: FantaTournamentsTeamsDao): FantaTournamentsTeamsRepository =
