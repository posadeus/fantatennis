...
class RetrieveAllFantaTournamentsRepositoryConfiguration {
  ...
  @Bean
  fun jdbcRetrieveAllFantaTournamentsRepository(jdbcTemplate: JdbcTemplate): RetrieveAllFantaTournamentsRepository =
      JdbcRetrieveAllFantaTournamentsRepository(jdbcTemplate)
}