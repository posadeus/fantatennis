...
import com.posadeus.fantatennis.infrastructure.repository.dispatcher.DispatcherTournamentInfoRepository
...
open class TournamentRepositoryConfiguration {
  ...
  @Bean
  open fun dispatcherTournamentInfoRepository(tennisTvTournamentInfoRepository: TennisTvTournamentInfoRepository,
                                              wimbledonTournamentInfoRepository: WimbledonTournamentInfoRepository)
  : TournamentInfoRepository =
      DispatcherTournamentInfoRepository(tennisTvTournamentInfoRepository,
                                         wimbledonTournamentInfoRepository)
}