...
open class TournamentInfoRepositoryConfiguration {
  ...
  @Bean
  open fun tournamentInfoRepositories(wimbledonTournamentInfoRepository: TournamentInfoRepository,
                                      tennisTvTournamentInfoRepository: TournamentInfoRepository) =
      listOf(wimbledonTournamentInfoRepository,
             tennisTvTournamentInfoRepository)
}