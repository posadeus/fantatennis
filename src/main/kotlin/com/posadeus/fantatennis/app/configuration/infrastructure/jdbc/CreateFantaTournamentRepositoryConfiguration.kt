...
class CreateFantaTournamentRepositoryConfiguration {
  ...
  @Bean
  fun sqlCreateFantaTournamentRepository(cachedFantaTournamentDao: FantaTournamentDao): CreateFantaTournamentRepository =
      SqlCreateFantaTournamentRepository(cachedFantaTournamentDao)
}